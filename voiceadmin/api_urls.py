...
urlpatterns = [
    ...
    url(r'performance_scores/$', views.PerformanceScoreList.as_view(), name='mentor-list'),
    url(r'performance_scores/(?P<pk>[0-9]+)$', views.PerformanceScoreDetail.as_view(), name='mentor-detail'),
